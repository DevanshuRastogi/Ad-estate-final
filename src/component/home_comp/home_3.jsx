                  ...
                  <Grid container>
                    <Grid item lg={9} md={9} sm={9} xs={9}>
                      <div className="f_list_1">
                        <ul>
                          <li>
                          <Link class="linkId" to="/buy">All Properties</Link>
                          </li>
                          <li>
                            <Link class="linkId" to="/buy">Villa</Link>
                          </li>
                          <li>
                            <Link class="linkId" to="/buy">Apartment</Link>
                          </li>
                          <li>
                            <Link class="linkId" to="/buy">Office</Link>
                          </li>
                        </ul>
                      </div>
                    </Grid>
                    <Grid item lg={3} md={3} sm={3} xs={3}>
                      <div className="f_list_2">
                        <Link to="/buy" class="linkId2" aria-label="See All Listing">
                          See All Listing
                        ...
                        <div className={`f_grid_${index + 1} f_grid_all`}>
                          ...
                          <div className="overlay1">
                            ...
                            <div className="grid_info">
                              <h4>{property.prop_name}</h4>
                              <div className="icon_info_1">
                                <div className="grid_info_icon_1">
                                  <AddLocationAltOutlinedIcon />
                                </div>
                                <p>{property.property_address.street}</p>
                              </div>
